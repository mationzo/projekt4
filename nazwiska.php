		...
		<table>
			...
			<?php
				...
				if (isset($_POST['delete_id'])) {
					...
					$sql = "DELETE FROM nazwiska WHERE ID_N = $delete_id";
				...
				if ($result = mysqli_query($do_bazy, 'SELECT * FROM nazwiska')) {
					while ($row = mysqli_fetch_assoc($result)) {
						...
						if (isset($_POST['edit_id']) && $_POST['edit_id'] == $row['ID_N']) {
							...
							echo "<input class='inputprzycisk' name='pole' type='text' value='" . $row['Nazwisko'] . "'>";
							echo "</td>";
							...
							echo "</form>";
							echo "<form method='POST' action='nazwiska.php' onsubmit='return confirm(\"Czy na pewno chcesz usunąć ten rekord?\")'>";
							echo "<input class='usun-przycisk' type='hidden' name='delete_id' value='" . $row['ID_N'] . "'>";
